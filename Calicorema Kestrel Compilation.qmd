...
\
To run this code, all raw Kestrel files should be placed within a folder titled "kestrel data". The "kestrel data" folder should be placed in the same folder as this .qmd file (this will be your working directory or the location of your R project).
